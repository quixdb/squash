...
namespace Squash {
  ...
  public class Stream : Squash.Object {
    [CCode (array_length_name = "avail_in", array_length_type = "size_t")]
    public unowned uint8[] next_in;
    public size_t total_in;
    [CCode (array_length_name = "avail_out", array_length_type = "size_t")]
  ...
  public class Codec {
    ...
    public Squash.Stream create_stream (Squash.StreamType stream_type, Squash.Options options);
    public Squash.Status compress (Squash.Codec codec, [CCode (array_length_type = "size_t")] uint8[] uncompressed, [CCode (array_length_type = "size_t")] uint8[] compressed, ...);
    public Squash.Status compress_with_options (Squash.Codec codec, [CCode (array_length_type = "size_t")] uint8[] uncompressed, [CCode (array_length_type = "size_t")] uint8[] compressed, Squash.Options options);
    public Squash.Status decompress (Squash.Codec codec, [CCode (array_length_type = "size_t")] uint8[] uncompressed, [CCode (array_length_type = "size_t")] uint8[] compresse, ...);
    public Squash.Status decompress_with_options (Squash.Codec codec, [CCode (array_length_type = "size_t")] uint8[] uncompressed, [CCode (array_length_type = "size_t")] uint8[] compressed, Squash.Options options);
  }
